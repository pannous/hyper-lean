...
There are several motivations why ε should be taught in school: Simple derivatives without limes, derivatives of step functions (dirac in physics), avoiding 0 probability for likely events and more.
