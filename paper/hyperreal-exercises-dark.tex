...
\href{https://files.pannous.com/hyperreal-exercise-solutions-dark.pdf}{\emph{Twenty Exercises in Algebraic Probability --- Solutions}}:
\begin{center}\small\url{https://files.pannous.com/hyperreal-exercise-solutions-dark.pdf}\end{center}
