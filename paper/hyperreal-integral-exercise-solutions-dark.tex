...
\textbf{Caution:} The atom here is $a\cdot \omega$ on the \emph{single} dot at $0$, not the symmetric
$\delta = \omega_0/2$ of Exercise 8. Both integrate to their mass, but only the
one-dot form returns the whole mass to $P(\{y\}) = p(y)\cdot \eps$. The two are
