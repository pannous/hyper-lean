...
\href{https://files.pannous.com/hyperreal-integral-exercise-solutions-dark.pdf}{\emph{Twenty Exercises in Probability on Ordinary Intervals --- Solutions}}:
\begin{center}\small\url{https://files.pannous.com/hyperreal-integral-exercise-solutions-dark.pdf}\end{center}
