...
-- axiom A : ∀ (r : R), true
instance : LinearOrderedField H.Hyper := H.field_Hyper
-- we are still deferring the proof, because Lean does not immediately check whether H.field_Hyper is actually computable
